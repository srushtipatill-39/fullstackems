...
import { ArrowLeftIcon, EyeIcon, EyeOffIcon, Loader, Loader2Icon } from "lucide-react";
        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div>
              ...
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder="srushti@gmail.com" />
            </div>
            <div>
